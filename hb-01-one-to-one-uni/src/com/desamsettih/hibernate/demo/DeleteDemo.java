...
public class DeleteDemo {
	...
	public static void main(String[] args) {
		...
		try {			
			...
			int theId = 6;
			Instructor newInstructor = session.get(Instructor.class, theId);
			
			System.out.println("Found instructor : "+newInstructor);
			
			//Delete the instructor
			if(newInstructor!=null)
			{
				System.out.println("Deleting instructor : "+newInstructor);
				session.delete(newInstructor);
			}
